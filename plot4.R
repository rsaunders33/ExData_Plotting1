...
#1,1
plot(hpcData$Date_Time,hpcData$Global_active_power,xlab="",ylab="Global Active Power", type="l")
...
#1,2
plot(hpcData$Date_Time,hpcData$Voltage,xlab="datetime",ylab="Voltage", type="l")

#2,2
plot(hpcData$Date_Time,hpcData$Global_reactive_power,xlab="datetime",ylab="Global_reactive_power", type="l")
